...
- **Status:** **ACCEPTED (revision 2, 2026-08-09) — OQ-3 resolved by the human: TimescaleDB.** The isolation strategy (MetricsReader port) is also ACCEPTED and stands unchanged. Revision 1 was BLOCKED on OQ-3; its option analysis is retained below as superseded context.
- **Date:** 2026-08-09
